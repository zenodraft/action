...
Zenodo (https://zenodo.org/account/settings/applications/) to create your own tokens, then go to https://github.com/%3Corganization%20name%3E%2F%3Crepository%20name%3E/settings/secrets/actions to set your repository secret.
