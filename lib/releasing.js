...
const create_github_release = (payload) => {
    core.group('WorkflowDispatchEvent payload', () => __awaiter(void 0, void 0, void 0, function* () { core.info(JSON.stringify(payload, null, 4)); }));
...
const move_git_tag = (payload) => {
    ...
    core.group('ReleasedEvent payload', () => __awaiter(void 0, void 0, void 0, function* () { core.info(JSON.stringify(payload, null, 4)); }));
