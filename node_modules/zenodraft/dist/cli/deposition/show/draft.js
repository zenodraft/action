...
const deposition_show_draft_command = () => {
    return new commander.Command()
        ...
        .action((concept_id, opts) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const draft_id = yield draft_1.deposition_show_draft(access_token, sandbox, concept_id, verbose);
