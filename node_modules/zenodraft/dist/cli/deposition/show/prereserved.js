...
const deposition_show_prereserved_command = () => {
    return new commander.Command()
        ...
        .action((version_id, opts) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const prereserved = yield prereserved_1.deposition_show_prereserved(access_token, sandbox, version_id, verbose);
