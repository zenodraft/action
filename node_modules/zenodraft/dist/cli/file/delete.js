...
const file_delete_command = () => {
    return new commander.Command()
        ...
        .action((version_id, remote_filename, opts) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield delete_1.file_delete(access_token, sandbox, version_id, remote_filename, verbose);
        }
        catch (e) {
