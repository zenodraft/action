...
export const file_add = (token, sandbox, version_id, filename, verbose = false) => __awaiter(void 0, void 0, void 0, function* () {
    if (verbose) {
    ...
    const response = yield fetch(`${bucket}/${filename}`, init);
    if (response.ok !== true) {
